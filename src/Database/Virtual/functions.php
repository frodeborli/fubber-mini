 ...
 * Configuration is loaded from _config/mini/Database/VirtualDatabase.php on first use.
 *
 ...
 * Usage:
 * ```php
 * // Register virtual tables in _config/mini/Database/VirtualDatabase.php
