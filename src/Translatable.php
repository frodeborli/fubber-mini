...
class Translatable implements \Stringable
{
    ...
    /**
     * Convert to string using global Translator instance
     */
    public function __toString(): string
    {
        // Use translator singleton if available, otherwise fallback to direct interpolation
        try {
    ...
    private function getCallingFile(): string
    {
        ...
        // Get project root from global app state if available
