...
/**
 * Mini Framework Documentation Tool
 *
 * Command-line tool for browsing PHP documentation using reflection.
 * Works with any PHP code - not just Mini framework.
 *
 * Features:
 ...
 * Usage:
 *   mini docs <target>
 *   mini docs search <pattern>
 *
 * Examples:
 *   mini docs mini                                        # Show mini namespace
 *   mini docs mini\\Mini                                  # Show Mini class
 *   mini docs mini\\db                                    # Show db() function
 *   mini docs search Router                               # Search for "Router"
...
if ($command === 'search') {
    ...
    if (!$searchCmd) {
        ...
        fwrite(STDERR, "  mini docs search Router         # Case-sensitive substring search\n");
        fwrite(STDERR, "  mini docs search -i router      # Case-insensitive search\n");
        fwrite(STDERR, "  mini docs search '/.*Router$/'  # Regex search (use / delimiters)\n");
        exit(1);
    }
...
Usage:
  mini docs <target>                    # Show documentation for specific entity
  mini docs search [-i] <pattern>       # Search names and signatures
  mini docs implements <interface>      # Find all implementations
  mini docs extends <class>             # Find all subclasses
  mini docs uses <trait>                # Find all trait users
  mini docs accepts <type>              # Find methods accepting a type
  mini docs returns <type>              # Find methods returning a type
  mini docs compatible <interface>      # Check interface compatibility
  mini docs attributes <attribute>      # Find attribute usage

Lookup Examples:
  mini docs mini                                        # Show namespace overview
  mini docs "mini\\Mini"                                # Show class documentation
  mini docs "mini\\Mini::get"                           # Show method documentation
  mini docs "mini\\db"                                  # Show function documentation

Search Examples (case-sensitive by default):
  mini docs search Router                               # Find "Router" in names/signatures
  mini docs search -i router                            # Case-insensitive search
  mini docs search '\$action'                           # Find methods with \$action parameter
